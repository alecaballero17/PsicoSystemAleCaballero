...
from .views import (
    DashboardAPIView, LogAuditoriaAPIView, PredictiveDiagnosisAPIView, 
    TransaccionListCreateAPIView, DescargarComprobantePDFAPIView, 
    VoiceQueryAPIView, BackupDatabaseAPIView, ReporteGeneralPDFAPIView, 
    ReporteGeneralCSVAPIView, RestoreDatabaseAPIView, DestruccionControladaAPIView,
...
urlpatterns = [
    ...
    path('api/mobile/transcribe/', TranscribeAudioAPIView.as_view(), name='mobile_transcribe'),
]
